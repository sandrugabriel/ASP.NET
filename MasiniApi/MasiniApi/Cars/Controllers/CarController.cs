...
namespace MasiniApi.Cars.Controllers
{
    ...
    public class CarController : CarApiController
    {
        ...
        public override async Task<ActionResult<IEnumerable<Car>>> GetCars()
        {
            try
            {
                IEnumerable<Car> cars = await _carQueryService.GetAllAsync();
        ...
        public override async Task<ActionResult<Car>> GetById([FromQuery] int id)
        {
            try
            {
                Car car = await _carQueryService.GetByIdAsync(id);
                return Ok(car);
            }
        ...
        public override async Task<ActionResult<Car>> GetByNameModel([FromQuery] string marca, [FromQuery] string model)
        {
            try
            {
        ...
        public override async Task<ActionResult<Car>> UpdateCar([FromQuery] int id, [FromBody] UpdateCarRequest request)
        {
            try
            {
        ...
        public override async Task<ActionResult<Car>> DeleteCar([FromQuery] int id)
        {
            try
            {
